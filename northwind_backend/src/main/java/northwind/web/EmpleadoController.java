...
public class EmpleadoController {
    ...
    public Empleado empleado(@PathVariable(value = "idEmpleado") Integer idEmpleado){
        try{
    ...
    public boolean deleteProvedor(@PathVariable("idEmpleado") Integer idEmpleado) {
        try {
    ...
    public Empleado updateProvedor(@PathVariable("idEmpleado") Integer idEmpleado,
